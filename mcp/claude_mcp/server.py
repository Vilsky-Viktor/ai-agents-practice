...
def create_default_template(template_path: Path, template_type: str) -> None:
    """Write a default PR template file if one doesn't already exist."""
...
async def get_pr_templates() -> str:
    ...
    for filename, template_type in DEFAULT_TEMPLATES.items():
        ...
        if not template_path.exists():
            create_default_template(template_path, template_type)
        templates.append({
            "filename": filename,
            "type": template_type,
