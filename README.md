...
Deployed Hugging Face Spaces: [profile](https://huggingface.co/spaces/viktor-vilskyi) · [first-agent](https://huggingface.co/spaces/viktor-vilskyi/first-agent) · [hf-certification-agent](https://huggingface.co/spaces/viktor-vilskyi/hf-certification-agent) · [mcp-sentiment](https://huggingface.co/spaces/viktor-vilskyi/mcp-sentiment)
...
- **[mcp/](mcp/)** — Model Context Protocol examples: a standalone MCP server, Gradio as an MCP server (deployed as [mcp-sentiment](https://huggingface.co/spaces/viktor-vilskyi/mcp-sentiment)), and MCP clients built three ways (`tiny-agents`, `smolagents`, `huggingface_hub.Agent`).
